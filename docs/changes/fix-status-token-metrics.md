...
(`FINDINGS.md`). 5 Commits, einer pro Bug-Gruppe.

## Commits

| # | Commit | Bug | Beschreibung |
|---|--------|-----|--------------|
...
| `src/core/statusSummary.ts` | 2, 5+6 |
| `src/cli/App.tsx` | 1, 2, 3, 4, 5+6 |
| `tests/agent.test.ts` | 1, 2, 4 |
| `tests/cli/App.test.tsx` | 1, 2, 4 |
| `tests/core/metrics.test.ts` | 2 |
| `tests/core/statusSummary.test.ts` | 2, 3, 5+6 |
